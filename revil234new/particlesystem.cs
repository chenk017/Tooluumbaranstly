...
namespace CoreTest.Inspectors
{
    ...
    {
        public static void Dump(AssetWorkspace workspace, AssetContainer cont)
        {
            Console.WriteLine();
            Console.WriteLine("========================================");
            Console.WriteLine(" ParticleSystem Inspector");
            Console.WriteLine("========================================");

            Console.WriteLine($"TypeID : {cont.ClassId}");
            Console.WriteLine($"Type   : ParticleSystem");
            ...
            {
                Console.WriteLine();
                Console.WriteLine("Gagal membaca BaseField ParticleSystem.");
                Console.WriteLine();
                return;
            }
